...
/**
 * Normalizes and processes rule actions.
 */
class Actions {
	 ...
	 * Normalize actions.
	 *
	 * @param array $actions The actions to normalize.
	 * @param array $ctx The context for the actions.
	 * @return array The normalized actions.
	 */
	...
	/**
	 * Convert applied actions to fees.
	 *
